...
# ---------------------------------------------------------------------------
# 结构化源码生成辅助层
# EN: Structured generation helpers
# ---------------------------------------------------------------------------
...
# EN: FileBuilder is ergonomic mutable state only. build() always returns an
# EN: immutable parser-backed CppDocument, so generated and parsed source converge.
@dataclass(slots=True)
