"""xr-syntax 自有 C++ source grammar 合同。
xr-syntax native C++ source-grammar contract, independent of Tree-sitter node-types metadata.
"""
...
from xr_syntax.core import GrammarNodeSpec, GrammarSlot, GrammarTypeRef, LanguageGrammar
...
# Grammar identity comes from this built-in contract, not a third-party grammar revision.
_SCHEMA_FINGERPRINT = "\n".join(
